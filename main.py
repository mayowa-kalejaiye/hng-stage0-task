...
app.add_middleware(
    ...
    allow_method=["GET"], # Only allow GET requests
...
def get_info():
    ...
    return {
        ...
        "current_datetime": datetime.now(pytz.utc).isoformat(),  # Get the current datetime in UTC and format it as ISO 8601 string
